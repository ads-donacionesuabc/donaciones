...
public class CategoriaLaboratorio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_categoria_laboratorio);
    ...
    private void consultaLibros(){
        ...
        Cursor cursor=db.rawQuery("SELECT * FROM donaciones where categoria ='Materiales de Lab'",null);
